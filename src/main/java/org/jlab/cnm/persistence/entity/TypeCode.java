 ...
 */
@Entity
@Table(name = "TYPE_CODE", schema = "CNM_OWNER", uniqueConstraints
        = {
            @UniqueConstraint(columnNames = {"SYSTEM_CODE_ID", "VV_CODE"})})
@NamedQueries({
    @NamedQuery(name = "TypeCode.findAll", query = "SELECT t FROM TypeCode t")})
