 ...
 * @author ryans
 */
@WebServlet(name = "StepThree", urlPatterns = {"/generator/step-three"})
public class StepThree extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/generator/step-three.jsp").forward(request, response);
    }
}
