...
public class SectorCodeFacade extends AbstractFacade<SectorCode> {
  ...
  public SectorCode findByCode(String code) {
    TypedQuery<SectorCode> q =
        em.createQuery("select s from SectorCode s where s.xxCode = :code", SectorCode.class);
  ...
  public void addSector(String code, String description, String grouping)
  ...
  @RolesAllowed("cnm-admin")
  public void editSector(BigInteger id, String code, String description, String grouping)
      throws UserFriendlyException {
  ...
  public List<String> findGroupingList() {
    Query q =
        em.createNativeQuery(
            "select distinct grouping from sector_code where grouping is not null order by grouping asc");
