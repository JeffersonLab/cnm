...
public class LocatorCodeFacade extends AbstractFacade<LocatorCode> {
  ...
  public LocatorCode findByCode(String code) {
    TypedQuery<LocatorCode> q =
        em.createQuery("select l from LocatorCode l where l.yyCode = :code", LocatorCode.class);
  ...
  public List<LocatorCode> findBySector(SectorCode sector) {
    TypedQuery<LocatorCode> q =
        em.createQuery(
            "select l from LocatorCode l where l.sectorCode.sectorCodeId = :sectorCodeId",
            LocatorCode.class);
